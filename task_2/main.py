...
shutil.copyfile("orders.json", "orders_new.json")


def write_order_to_json(item, quantity, price, buyer, date):
    with open('orders_new.json', 'r', encoding='utf-8') as f:
        json_load = json.load(f)
    json_load['orders'].append({
        "item": item,
        "quantity": quantity,
        "price": price,
        "buyer": buyer,
    ...
    with open('orders_new.json', 'w', encoding='utf-8') as f:
