## Урок pyqt 7. PEP-8, подготовка документации
* 0:04 startweb
* 0:14 code style
* 0:15 pylint
* 0:28 ex_2
...
2. Проверить программный код практических заданий текущего курса и курса Python-1 на соответствие положениям PEP-8. При необходимости выполнить преобразования.
