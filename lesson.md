## Урок pyqt 3. Хранение данных в БД. ORM SQLAlchemy
* 0:10 startweb
* 0:22 description
* 0:37 exp_1 commit
* 0:42 exp_2 executescript
* 0:50 exp_3 parameters ?
* 0:56 exp_4 for
* 0:57 exp_5 error
* 1:03 relax 1:14
* 1:02 exp_6 SQLAlchemy mapper session
* 1:23 exp_7 declarative_base
* 1:26 hw
...
Опорная схема базы данных на стороне сервера БД содержит следующие таблицы:
* клиент:
  * логин;
  * информация.
* история_клиента:
